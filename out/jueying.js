...
(function (jueying) {
    ...
    jueying.NotDomPropPrefix = 'ctrl_';
    ...
    jueying.Component = Component;
    jueying.FormContext = React.createContext({ form: null });
    class ContainerHost extends React.Component {
        ...
        render() {
            ...
            return React.createElement(jueying.FormContext.Provider, { value: { form: this } }, children);
        }
    }
    ...
    class ComponentContainer extends React.Component {
        ...
        render() {
            return React.createElement(jueying.FormContext.Consumer, null, (args) => {
