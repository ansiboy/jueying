...
//         // 各个控件相同的编辑器
//         let commonPropEditorInfos: PropertyEditorInfo[] = []
...
//             }
//             else {
//                 let items: PropertyEditorInfo[] = []
//                 commonPropEditorInfos.forEach(propInfo1 => {
//                     propEditorInfos.forEach(propInfo2 => {
//                         let propName1 = propInfo1.propertyName;
//                         let propName2 = propInfo2.propertyName;
...
//             let propName = propEditorInfo.propertyName;;
...
//                         componentId: o.id, propName: propEditorInfo.propertyName, value
//                     }));

//                     if (this._validator == null) {
//                         this._validateFields = commonPropEditorInfos.filter(o => o.validation != null)
//                             .map(o => Object.assign(o.validation as any, { name: o.propertyName, rules: [] }));
//                         this._validator = new FormValidator(this.element, ...this._validateFields);

//                     }

//                     if (this._validateFields.filter(o => o.name == propEditorInfo.propertyName).length > 0)
//                         this._validator.checkElement(propEditorInfo.propertyName);
...
//             editors.push({ prop: propEditorInfo.propertyName, displayName: propEditorInfo.displayName, editor, group: propEditorInfo.group || "" })
//         }
